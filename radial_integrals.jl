...
function square_brackets_equation(n1, n2, n3, n4, l1_, l2_, l3_, l4_, xi1, xi2, xi3, xi4; target=:l4)
...
# @memoize 
function square_brackets(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; rtol=1e-8)
    ...
    if n4-1 != l4
        ret = square_brackets_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l4)
    end

    if n3-1 != l3
        ret = square_brackets_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l3)
    end

    if n2-1 != l2
        ret = square_brackets_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l2)
    end

    if n1-1 != l1
        ret = square_brackets_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l1)
    end
...
function round_brackets_1_equation(n1, n2, n3, n4, l1_, l2_, l3, l4, xi1, xi2, xi3, xi4; sign=+1, target=:l4)
    l1 = l1_; l2 = l2_; 
    l_plus = -l - 1
    l_minus = l
    ...
    ret = -sign * square_brackets(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4) + 
        c1 * round_brackets(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4, sign=sign) +
        c2 * round_brackets(n1, n2, n3, n4, l1, l2+1, l3, l4, xi1, xi2, xi3, xi4, sign=sign) + 
        c3 * round_brackets(n1, n2, n3, n4, l1+1, l2, l3, l4, xi1, xi2, xi3, xi4, sign=sign) 
    return ret / c0
end

function round_brackets_2_equation(n1, n2, n3, n4, l1, l2, l3_, l4_, xi1, xi2, xi3, xi4; sign=+1, target=:l4)
    l3 = l3_; l4 = l4_; 
    l_plus = -l - 1
    l_minus = l
    ...
    ret = sign * square_brackets(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4) + 
        c1 * round_brackets(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4, sign=sign) +
        c2 * round_brackets(n1, n2, n3, n4, l1, l2, l3, l4+1, xi1, xi2, xi3, xi4, sign=sign) + 
        c3 * round_brackets(n1, n2, n3, n4, l1, l2, l3+1, l4, xi1, xi2, xi3, xi4, sign=sign) 
    return ret / c0
end

# @memoize 
function round_brackets(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; sign=+1, rtol=1e-8)
    if (n1-1 < l1) | (n2-1 < l2) | (n3-1 < l3) | (n4-1 < l4) 
        return 0.
    end
    ...
    if n4-1 != l4
        ret = round_brackets_2_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l4)
    end

    if n3-1 != l3
        ret = round_brackets_2_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l3)
    end

    if n2-1 != l2
        ret = round_brackets_1_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l2)
    end

    if n1-1 != l1
        ret = round_brackets_1_equation(n1, n2, n3, n4, l1, l2, l3, l4, xi1, xi2, xi3, xi4; target=:l1)
    end
    # println("ret", ret)
    return ret
end
